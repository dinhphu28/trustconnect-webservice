...
import com.idb.apispr.Models.ImpContactsPayloadV2Model;
...
public class ContactV2Controller {
    ...
    public ResponseEntity<Object> createBatchContacts(@RequestBody ImpContactsPayloadV2Model contactModel, @RequestHeader(value = "X-API-KEY", required = true) String apiKey) {
        ...
        if(apiKey.equals(localApiKey)) {
            ...
            if(sourceCall != null) {
                ...
                try {
                    ...
                    impResult = impResultService.execImportContactsV3(jsonCM, "clientapi", "Client API", contactModel.getSourceCall());
                } catch (Exception e) {
